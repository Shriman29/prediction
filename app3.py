...
@app.route('/')
def home():
    return render_template('mng.html')
...
def predict():
    ...
    return render_template('mng.html', prediction_text='You may have change to get entrance in:  {}'.format(
        college[clg_code.index(int(userpreddt[0]))]))
